...
function stateChange() {
    if (http_request.readyState == 4) {
        if (http_request.status == 0 || http_request.status == 200) {
            ...
            /*tData = getData(data[1]);
            drawCurveDay(tData,"#placeholder2");
            tData = getData(data[2]);
            drawCurveDay(tData,"#placeholder3");
            tData = getData(data[3]);
            drawCurveDay(tData,"#placeholder4");
            tData = getData(data[3]);
            drawCurveDay(tData,"#placeholder4");
            tData = getData(data[4]);
            drawCurveDay(tData,"#placeholder5");
            tData = getData(data[5]);
            drawCurveDay(tData,"#placeholder6");
            tData = getData(data[6]);
            drawCurveDay(tData,"#placeholder7");
            tData = getData(data[7]);
            drawCurveDay(tData,"#placeholder8");*/
